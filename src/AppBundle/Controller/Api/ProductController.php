...
class ProductController extends ApiController
{
    ...
    public function listAction(Request $request)
    {
        ...
        $context = new Context();
        $context->setGroups(['Default', 'products_list'])
    ...
    public function createAction(Request $request)
    {
        ...
        $context = new Context();
        $context->setGroups(['Default', 'products_create']);
    ...
    public function readAction(Product $product = null)
    {
        ...
        $context = new Context();
        $context->setGroups(['Default', 'products_read']);
    ...
    public function updateAction(Request $request, Product $product = null)
    {
        ...
        $context = new Context();
        $context->setGroups(['Default', 'products_update']);

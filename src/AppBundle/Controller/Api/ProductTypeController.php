...
class ProductTypeController extends ApiController
{
    ...
    public function listAction(Request $request)
    {
        ...
        $context = new Context();
        $context->setGroups(['Default', 'product_types_list'])
    ...
    public function createAction(Request $request)
    {
        ...
        $context = new Context();
        $context->setGroups(['Default', 'product_types_create']);
    ...
    public function readAction(ProductType $productType = null)
    {
        ...
        $context = new Context();
        $context->setGroups(['Default', 'product_types_read']);
    ...
    public function updateAction(Request $request, ProductType $productType = null)
    {
        ...
        $context = new Context();
        $context->setGroups(['Default', 'product_types_update']);

...
class UserController extends ApiController
{
    ...
    public function listAction(Request $request)
    {
        ...
        $users = $this->get('app.manager.user')->findAll();

        $context = new Context();
        $context->setGroups(['Default', 'users_list'])
    ...
    public function createAction(Request $request)
    {
        ...
        $context = new Context();
        $context->setGroups(['Default', 'users_create']);
    ...
    public function readAction(User $user = null)
    {
        ...
        $context = new Context();
        $context->setGroups(['Default', 'users_read']);
    ...
    public function updateAction(Request $request, User $user = null)
    {
        ...
        $context = new Context();
        $context->setGroups(['Default', 'users_update']);

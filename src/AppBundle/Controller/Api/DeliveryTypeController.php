...
class DeliveryTypeController extends ApiController
{
    ...
    public function listAction(Request $request)
    {
        ...
        $context = new Context();
        $context->setGroups(['Default', 'delivery_types_list'])
    ...
    public function createAction(Request $request)
    {
        ...
        $context = new Context();
        $context->setGroups(['Default', 'delivery_types_create']);
    ...
    public function readAction(DeliveryType $deliveryType = null)
    {
        ...
        $context = new Context();
        $context->setGroups(['Default', 'delivery_types_read']);
    ...
    public function updateAction(Request $request, DeliveryType $deliveryType = null)
    {
        ...
        $context = new Context();
        $context->setGroups(['Default', 'delivery_types_update']);
